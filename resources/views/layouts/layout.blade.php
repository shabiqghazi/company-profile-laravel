...
<html lang="en">
  ...
  <body>
    @if(Request::path() === '/')
      <div
        class="h-screen w-full flex items-center bg-center bg-[linear-gradient(rgba(0,0,0,0.4),rgba(0,0,0,0.4)),url('http://127.0.0.1:8000/assets/img/leading_background.jpg')] bg-cover"
        id="featured"
      >
